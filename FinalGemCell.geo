// Gmsh project created on Wed Oct 11 11:00:57 2023
SetFactory("OpenCASCADE");


//cathode to top of GEM 5.2cm
//lower GEM to readout 
//cm
//inner hourglass 50um, hole diameter 70um
r0 = 0.0035;     // the hole radius
r1 = 0.001;     // the etching amount (etch radius = r0 + r1)
...
b = 0.001; //how far in the hourglass narrow part is
...
cmue1_1 = newc; Circle(cmue1_1) = {pme1_1, pc5_1, pme2_1};


// Lines connecting middle to top and bottom
lconn1_1 = newc; Line(lconn1_1) = {pme1_1, pth1_1};
lconn2_1 = newc; Line(lconn2_1) = {pbh1_1, pme1_1};
lconn3_1 = newc; Line(lconn3_1) = {pme2_1, pth2_1};
lconn4_1 = newc; Line(lconn4_1) = {pbh2_1, pme2_1};
...
pme2_3 = newp; Point(pme2_3) = {a/2,(a*Sqrt(3)/2-1*(r0+r1))+2*r1,0,lcEtchingHole};
cmh2_1 = newc; Circle(cmh2_1) = {pme2_1, pc5_2, pme2_3};
cmh2_2 = newc; Circle(cmh2_2) = {pme2_3, pc5_2, pme2_2};
...
lconn1_2 = newc; Line(lconn1_2) = {pme2_2, pth1_2};
lconn2_2 = newc; Line(lconn2_2) = {pme2_1, pth2_2};
lconn3_2 = newc; Line(lconn3_2) = {pme2_1, pbh2_2};
lconn4_2 = newc; Line(lconn4_2) = {pbh1_2, pme2_2};

lconn5_2 = newc; Line(lconn5_2) = {ptle1_2, pbue1_2};
lconn6_2 = newc; Line(lconn6_2) = {ptle2_2, pbue2_2};
lconn7_2 = newc; Line(lconn7_2) = {pbue3_2, ptle3_2};

//Added (split these into lconnt, loconnb
lconn8_2 = newc; Line(lconn8_2) = {pth3_2, pme2_3};
lconn9_2 = newc; Line(lconn9_2) = {pme2_3, pbh3_2};
...
cmue1_3 = newc; Circle(cmue1_3) = {pme3_1, pc5_3, pme3_2};

//*****

// Lines connecting top and bottom **check again
lconn1_3 = newc; Line(lconn1_3) = {pme3_2, pth1_3};
lconn2_3 = newc; Line(lconn2_3) = {pbh2_3, pme3_1};
lconn3_3 = newc; Line(lconn3_3) = {pme3_1, pth2_3};
lconn4_3 = newc; Line(lconn4_3) = {pbh1_3, pme3_2};
...
// Copper plate surfaces (the same from ex)
...
//back of hole 2 in 4 pieces
//topleft1 234,-214,240,-217
ll_cyl_dielectric2_1 = newreg; Line Loop(ll_cyl_dielectric2_1) = {lconn2_2, cth2_2, lconn8_2, -cmh2_1};
rs_cyl_dielectric2_1 = newreg; Surface(rs_cyl_dielectric2_1) = {ll_cyl_dielectric2_1};

//botleft2 235,217,241,216
ll_cyl_dielectric2_2 = newreg; Line Loop(ll_cyl_dielectric2_2) = {lconn3_2, cmh2_1, lconn9_2, cbh2_2};
rs_cyl_dielectric2_2 = newreg; Surface(rs_cyl_dielectric2_2) = {ll_cyl_dielectric2_2};

//topright3 233,213,240,218
ll_cyl_dielectric2_3 = newreg; Line Loop(ll_cyl_dielectric2_3) = {lconn1_2, cth1_2, lconn8_2, cmh2_2};
rs_cyl_dielectric2_3 = newreg; Surface(rs_cyl_dielectric2_3) = {ll_cyl_dielectric2_3};

//botright4 236,-218,241,-215
ll_cyl_dielectric2_4 = newreg; Line Loop(ll_cyl_dielectric2_4) = {lconn4_2, -cmh2_2, lconn9_2, -cbh1_2};
...
//back of hole 3,1
//bot250,-248,-252,243
ll_cyl_dielectric3_1 = newreg; Line Loop(ll_cyl_dielectric3_1) = {lconn2_3, -cmue1_3,lconn4_3,cbh1_3};
rs_cyl_dielectric3_1 = newreg; Surface(rs_cyl_dielectric3_1) = {ll_cyl_dielectric3_1};

//top 251, -242,-249
ll_cyl_dielectric3_2 = newreg; Line Loop(ll_cyl_dielectric3_2) = {lconn3_3, -cth1_3, -lconn1_3, cmue1_3};
rs_cyl_dielectric3_2 = newreg; Surface(rs_cyl_dielectric3_2) = {ll_cyl_dielectric3_2};

//bot 208,-206,-210,201
ll_cyl_dielectric1_1 = newreg; Line Loop(ll_cyl_dielectric1_1) = {lconn2_1, cmue1_1,lconn4_1,cbh1_1};
rs_cyl_dielectric1_1 = newreg; Surface(rs_cyl_dielectric1_1) = {ll_cyl_dielectric1_1};

//top 207,200,209,206
ll_cyl_dielectric1_2 = newreg; Line Loop(ll_cyl_dielectric1_2) = {lconn1_1, -cth1_1, -lconn3_1, cmue1_1};
rs_cyl_dielectric1_2 = newreg; Surface(rs_cyl_dielectric1_2) = {ll_cyl_dielectric1_2};

//done
ll_side_dielectric1a = newreg; Line Loop(ll_side_dielectric1a) = {-lconn1_1,lcpt20, -lconn6_1, -lcpb20, -lconn2_1};
...
ll_side_dielectric1c = newreg; Line Loop(ll_side_dielectric1c) = {lconn1_3, lcpt18, lconn5_3, -lcpb18,lconn4_3};
...
ll_side_dielectric2b = newreg; Line Loop(ll_side_dielectric2b) = {lconn2_3, lconn3_3,lcpt15, -lconn6_3, -lcpb15};
ps_side_dielectric2b = newreg; Plane Surface(ps_side_dielectric2b) = {ll_side_dielectric2b};
ll_side_dielectric3a = newreg; Line Loop(ll_side_dielectric3a) = {lcpt13, -lcpb31, -lcpb13, lconn6_2};
ps_side_dielectric3a = newreg; Plane Surface(ps_side_dielectric3a) = {ll_side_dielectric3a};
ll_side_dielectric3b = newreg; Line Loop(ll_side_dielectric3b) = {lconn6_2, -lcpt12, -lconn2_2,-lconn3_2,lcpb12};
ps_side_dielectric3b = newreg; Plane Surface(ps_side_dielectric3b) = {ll_side_dielectric3b};
ll_side_dielectric4a = newreg; Line Loop(ll_side_dielectric4a) = {lcpt10, -lconn1_2,-lconn4_2,-lcpb10, lconn5_2};
ps_side_dielectric4a = newreg; Plane Surface(ps_side_dielectric4a) = {ll_side_dielectric4a};
ll_side_dielectric4b = newreg; Line Loop(ll_side_dielectric4b) = {lconn5_2, -lcpt9, -lcpb32, lcpb9};
...
ll_side_dielectric5b = newreg; Line Loop(ll_side_dielectric5b) = {lcpt7, lconn5_1, -lcpb7, lconn4_1,lconn3_1};
...
// Bounding surfaces done
ll_bsurf1 = newreg; Line Loop(ll_bsurf1) = {-lconn1_3, lcpt17, -lcpb33, -lcpb17, lconn4_3};
ps_bsurf1 = newreg; Plane Surface(ps_bsurf1) = {ll_bsurf1};
ll_bsurf2 = newreg; Line Loop(ll_bsurf2) = {lcpb33, -lcpb16, lconn2_3, lconn3_3, lcpt16};
ps_bsurf2 = newreg; Plane Surface(ps_bsurf2) = {ll_bsurf2};
ll_bsurf3a = newreg; Line Loop(ll_bsurf3a) = {lconn1_2, lcpt11a, lshalf2, -lcpb11a, lconn4_2};
ps_bsurf3a = newreg; Plane Surface(ps_bsurf3a) = {ll_bsurf3a};
ll_bsurf3b = newreg; Line Loop(ll_bsurf3b) = {-lconn2_2, lcpt11b, -lshalf2, -lcpb11b, lconn3_2};
ps_bsurf3b = newreg; Plane Surface(ps_bsurf3b) = {ll_bsurf3b};
ll_bsurf4 = newreg; Line Loop(ll_bsurf4) = {lcpt6, -lconn3_1, lconn4_1, -lcpb6, -lcpb30};
ps_bsurf4 = newreg; Plane Surface(ps_bsurf4) = {ll_bsurf4};
ll_bsurf5 = newreg; Line Loop(ll_bsurf5) = {lcpt21, lcpb30, -lcpb21,lconn2_1,lconn1_1};
ps_bsurf5 = newreg; Plane Surface(ps_bsurf5) = {ll_bsurf5};

//6-15should be the same
...
//these are fine
sl_dielectric = newreg; Surface Loop(sl_dielectric) = {ps_top_dielectric, ps_bottom_dielectric, ps_side_dielectric1a, ps_side_dielectric1b, ps_side_dielectric1c, ps_side_dielectric1d, ps_up_dielectric_1, ps_up_dielectric_3, ps_low_dielectric_1, ps_low_dielectric_3, ps_side_dielectric2a, ps_side_dielectric2b, ps_side_dielectric3a, ps_side_dielectric3b, ps_side_dielectric4a, ps_side_dielectric4b, ps_side_dielectric5a, ps_side_dielectric5b, ps_up_dielectric_2, ps_low_dielectric_2, rs_cyl_dielectric2_1, rs_cyl_dielectric2_2, rs_cyl_dielectric2_3, rs_cyl_dielectric2_4, rs_cyl_dielectric1_1,rs_cyl_dielectric1_2, rs_cyl_dielectric3_1,rs_cyl_dielectric3_2};
vol_dielectric = newreg; Volume(vol_dielectric) = {sl_dielectric};

sl_gas = newreg; Surface Loop(sl_gas) = {ps_bsurf9, ps_bsurf6a, ps_bsurf6b, ps_bsurf15, ps_bsurf7a, ps_bsurf7b, ps_bsurf8, ps_bsurf4, ps_bsurf12, ps_bsurf14, ps_bsurf11a, ps_bsurf11b, ps_bsurf5, ps_bsurf1, ps_bsurf2, ps_bsurf10, ps_bsurf13a, ps_bsurf13b, ps_bsurf3a, ps_bsurf3b, rs_cyl_dielectric2_1, rs_cyl_dielectric2_2, ps_up_dielectric_2, rs_cyl_dielectric2_3, rs_cyl_dielectric2_4, ps_low_dielectric_2, rscp_low_rim2_2, rscp_low_rim_1, rscp_low_rim_3, rscp_low_rim1_2, rscp_up_rim2_2, rscp_up_rim1_2, pscp_face1, pscp_face2, rscp_up_rim_1, rs_cyl_dielectric3_1,rs_cyl_dielectric3_2, ps_up_dielectric_3, ps_low_dielectric_3, rscp_up_rim_3, rs_cyl_dielectric1_1,rs_cyl_dielectric1_2, ps_up_dielectric_1, ps_low_dielectric_1};
